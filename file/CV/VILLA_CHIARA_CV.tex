...
{\bf Software} &  MATLAB, Python, Stan (C++), Fortran90, COMSOL,
 Maple, R, HTML5 \\
%{\bf Memberships} & { European Society for Mathematical and Theoretical Biology (ESMTB)}, {Society for Mathematical Biology (SMB),  Société de Mathématiques Appliquées et Industrielles (SMAI), Marie Curie Alumni Association (MCAA), European Mathematical Society Topical Activity Group Mathematical Modelling in Life Sciences (EMS-TAG-MLS)} \\
{\bf Memberships} & \href{https://www.esmtb.org/}{ESMTB}, \href{https://smb.org/}{SMB},  \href{http://smai.emath.fr/?lang=fr}{SMAI}, \href{https://www.mariecuriealumni.eu/}{MCAA}, \href{https://complexcite.u-pariscite.fr/}{ComplexCité}, \href{https://sites.google.com/view/ems-tag-mls}{EMS-TAG-MLS}\\
...
\renewcommand{\arraystretch}{1}
\begin{tabularx}{\linewidth}{>{\hsize=.27\hsize}X> {\hsize=1.73\hsize}X}
{01/26 - today} & {{\bf PhD thesis supervision} (co-encadrante) of \href{https://perlamallouk.com/}{Perla Mallouk} (MAP5, UPCité)}\\
{09/23 - today} & {{\bf PhD thesis supervision} (co-encadrante) of \href{https://federicapadovano.github.io/index.html}{Federica Padovano} (LJLL, SU)}\\
{01/26 - 07/26} & {{\bf Master thesis} (M2) of Tom Matrat (amU), at ESILV and MAP5 (UPCité)}\\
{01/23 - 08/23} & {{\bf Master thesis} of Federica Padovano (EPFL), at LJLL (SU)}\\
\end{tabularx} 
...
\underline{\em Journal peer reviewing} (12 manuscripts)  \\[3pt]
\noindent
%\renewcommand{\arraystretch}{1}
%\begin{tabularx}{\linewidth}{>{\hsize=.27\hsize}X> {\hsize=1.73\hsize}X}
...
%\end{tabularx} 
{PLOS Computational Biology}, {Journal of Mathematical Biology},  {International Journal of Non-Linear Mechanics},  {Bulletin of Mathematical Biology},  {iScience}, {European Journal of Applied Mathematics}, {Mathematical Biosciences},  {European Control Conference 2022}, {Frontiers in Ecology and Evolution} %(Special issue: From Ecology to Cancer Biology and Back Again)\\
...
{04/26} & {\bf Rendez-Vous des Jeunes Mathématiciennes et Informaticiennes}, \textit{MAP5, Universit{\'e} Paris Cit{\'e}}, Testimonial for female high school students interested in pursuing STEM subjects in higher education\\
{04/26} & {\bf W MathBio!} invited speaker at the online seminar for women in Mathematical Biology\\
...
\noindent
\renewcommand{\arraystretch}{1}
\begin{tabularx}{\linewidth}{>{\hsize=.21\hsize}X> {\hsize=1.73\hsize}X}
{Jul 2026} & {\bf Minisymposium} `Identifying the origin and consequences of non-genetic cell-to-cell variability', \textit{ECMTB2026}  \\
{Jun 2025} & {\bf Minisymposium} `Mathematical advances in modelling cancer treatment', \textit{SMAI 2025}  \\
{Jul 2024} & {\bf Minisymposium} `Recent advances in modelling cancer invasion', \textit{ECMTB2024}  \\
{Oct 2023 \hfill } & {\bf Workshop `Mathematical challenges in modelling cancer dynamics'} ($\sim$ 50 ppl),  \textit{Laboratoire Jacques-Louis Lions, Sorbonne Universit{\'e}},  https://mc2d.sciencesconf.org/  \\
{2020-2021} & {\bf StAMBio seminar series},  Weekly talks (online) by members of the St Andrews Mathematical Biology research group and international guest speakers  \\
{Jan 2020} & {\bf Postgraduate Interdisciplinary Mathematics Symposium}, {for PhD students of the School of Mathematics and Statistics of the University of St Andrews}, {\em  Edzell} \\
{ Dec 2019} & {\bf Workshop `Scottish Mathematical Biology Forum'}, {\em  ICMS, Edinburgh} \\
\end{tabularx} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{tabularx}{\linewidth}{>{\hsize=.27\hsize}X> {\hsize=1.73\hsize}X}
%{07/26} & {\bf Minisymposium} `Identifying the origin and consequences of non-genetic cell-to-cell variability', \textit{ECMTB2026}  \\
...
{Jul 2026} & {\bf Mathematical modeling in biology and medicine}, {\em Wolfgang Pauli Institute} (Vienna) \\
{Jun 2026} & {\bf In silico Health %: Modèles In Silico pour la Santé
}, {\em DVRS, ESILV and Centre Hospitalier de Saint-Denis} \\
{Feb 2026} & {\bf From Micro to Macro in Mathematical Biology}, {\em Politecnico di Torino} \\
{Dec 2025} & {\bf New trends in mathematical models for biology}, {\em Institut Henri Poincaré} (Paris)\\
{Apr 2025} & {\bf Young women in Mathematical Biology}, {\em Bonn University} \\
{Apr 2024} & {\bf Mathematical and numerical tools for Oncology}, {\em Oncolille Institut} (Lille)\\
...
{Oct 2022} & {\bf Modelling cell and tissue biomechanics}, {{\em LJLL, Sorbonne University} (Paris)} \\
...
%\end{tabularx} 
\begin{tabularx}{\linewidth}{>{\hsize=.21\hsize}X> {\hsize=1.79\hsize}X}
{Jul 2026} & {\bf 14th ECMTB}, {`Modeling collective dynamics in heterogeneous cell populations'}, \textit{Graz}\\
